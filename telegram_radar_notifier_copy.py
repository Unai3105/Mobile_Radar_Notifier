...
def comprobar_radares(html):
    ...
    try:
        ...
        # Buscar el título de la sección donde se mencionan los radares
        # Buscamos un <p> que contenga la fecha actual y la cadena específica
        ubicaciones = []
